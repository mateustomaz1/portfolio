...
export function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: "/hopin.png",
      category: "backend",
      technologies: ["React Native", "Spring Boot", "TypeScript"],
      liveUrl: "https://github.com/lucasramallo/hopin-mobile?tab=readme-ov-file",
      githubUrl: "https://github.com/lucasramallo/hopin-mobile?tab=readme-ov-file",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      description:
        "Projeto desenvolvido durante uma live da OneBit Code, onde construímos uma aplicação web para gerenciar aulas de música.",
      image: "/tom.png",
      category: "frontend",
      technologies: ["HTML", "CSS", "GIT", "Github"],
      liveUrl: "https://jazzschol.netlify.app/",
